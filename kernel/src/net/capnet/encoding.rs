...
pub use super::legacy::{
    ...
    CAPNET_CONSTRAINT_REQUIRE_BYTE_QUOTA, CAPNET_CONSTRAINT_SESSION_BOUND, CAPNET_CONTROL_PORT,
    CAPNET_CTRL_MAX_FRAME_LEN, CAPNET_CTRL_MAX_PAYLOAD, CAPNET_MAX_DELEGATION_DEPTH,
    CAPNET_MAX_PEERS, CAPNET_TOKEN_MAGIC, CAPNET_TOKEN_V1_LEN, CAPNET_TOKEN_VERSION_V1,
};
