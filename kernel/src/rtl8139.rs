...
#[repr(C, align(4))]
struct TxBufArray { data: [[u8; TX_BUF_SIZE]; TX_DESC_COUNT] }
static mut TX_BUFS: TxBufArray = TxBufArray { data: [[0u8; TX_BUF_SIZE]; TX_DESC_COUNT] };

#[repr(C, align(4))]
struct RxBuf { data: [u8; RX_BUF_SIZE] }
static mut RX_BUF: RxBuf = RxBuf { data: [0u8; RX_BUF_SIZE] };
...
impl Rtl8139Driver {
    ...
    pub fn init(&mut self) -> bool {
        unsafe {
            ...
            for _ in 0..100_000u32 {
                if self.inb(RTL_CR) & CR_RST == 0 { break; }
            }
    ...
    pub fn send(&mut self, frame: &[u8]) -> bool {
        ...
        unsafe {
            ...
            for _ in 0..2_000_000u32 {
                if self.ind(tsd) & TSD_OWN != 0 { break; }
            }
    ...
    pub fn recv(&mut self, buf: &mut [u8]) -> usize {
        ...
        unsafe {
            ...
            if self.inb(RTL_CR) & CR_BUFE != 0 { return 0; }
...
pub fn init(pci_devices: &[PciDevice]) {
    for &dev in pci_devices {
        ...
        if bar0 == 0 || bar0 & 1 == 0 { continue; } // must be I/O BAR
