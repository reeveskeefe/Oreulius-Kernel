...
impl HdaController {
    pub fn new(mmio_base: usize, pci: PciDevice) -> Self {
        HdaController { mmio_base, pci, initialised: false, corb_wp: 0, rirb_rp: 0 }
    }
...
// ============================================================================
// AC'97 Controller (fallback for QEMU + older hardware)
// ============================================================================
//
...
pub fn set_volume(_level: u8) {
    // TODO: map 0–255 to HDA amp gain or AC'97 master volume attenuation field
}
